...
user/_arr:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
   ...
   8:	87aa                	mv	a5,a0
   a:	f8b43023          	sd	a1,-128(s0)
   e:	f8f42623          	sw	a5,-116(s0)
    uint64 buf[10];

    int size = get_arr(buf);
  12:	f9840793          	addi	a5,s0,-104
  16:	853e                	mv	a0,a5
  18:	00000097          	auipc	ra,0x0
  1c:	5d8080e7          	jalr	1496(ra) # 5f0 <get_arr>
  20:	87aa                	mv	a5,a0
  ...
  30:	d8450513          	addi	a0,a0,-636 # db0 <malloc+0x13e>
  34:	00001097          	auipc	ra,0x1
  38:	a4c080e7          	jalr	-1460(ra) # a80 <printf>

    for (int i = 0; i < size; i++) {
  3c:	fe042623          	sw	zero,-20(s0)
  40:	a81d                	j	76 <main+0x76>
        printf("buf[%d] %d\n", i, (int)buf[i]);
  42:	fec42783          	lw	a5,-20(s0)
  46:	078e                	slli	a5,a5,0x3
  48:	17c1                	addi	a5,a5,-16
  4a:	97a2                	add	a5,a5,s0
  4c:	fa87b783          	ld	a5,-88(a5)
  50:	0007871b          	sext.w	a4,a5
  54:	fec42783          	lw	a5,-20(s0)
  58:	863a                	mv	a2,a4
  5a:	85be                	mv	a1,a5
  5c:	00001517          	auipc	a0,0x1
  60:	d6450513          	addi	a0,a0,-668 # dc0 <malloc+0x14e>
  64:	00001097          	auipc	ra,0x1
  68:	a1c080e7          	jalr	-1508(ra) # a80 <printf>
    for (int i = 0; i < size; i++) {
  ...
  80:	2701                	sext.w	a4,a4
  82:	2781                	sext.w	a5,a5
  84:	faf74fe3          	blt	a4,a5,42 <main+0x42>
    }
  ...
  8a:	853e                	mv	a0,a5
  8c:	70e6                	ld	ra,120(sp)
  8e:	7446                	ld	s0,112(sp)
  90:	6109                	addi	sp,sp,128
  92:	8082                	ret
...
_main()
{
  ...
  aa:	49a080e7          	jalr	1178(ra) # 540 <exit>
...
{
  ae:	7179                	addi	sp,sp,-48
  b0:	f422                	sd	s0,40(sp)
  b2:	1800                	addi	s0,sp,48
  b4:	fca43c23          	sd	a0,-40(s0)
  b8:	fcb43823          	sd	a1,-48(s0)
  char *os;
  ...
  while((*s++ = *t++) != 0)
  c4:	0001                	nop
  c6:	fd043703          	ld	a4,-48(s0)
  ca:	00170793          	addi	a5,a4,1
  ce:	fcf43823          	sd	a5,-48(s0)
  d2:	fd843783          	ld	a5,-40(s0)
  d6:	00178693          	addi	a3,a5,1
  da:	fcd43c23          	sd	a3,-40(s0)
  de:	00074703          	lbu	a4,0(a4)
  e2:	00e78023          	sb	a4,0(a5)
  e6:	0007c783          	lbu	a5,0(a5)
  ea:	fff1                	bnez	a5,c6 <strcpy+0x18>
    ;
  return os;
...
strlen(const char *s)
{
 ...
 186:	f7e5                	bnez	a5,16e <strlen+0x10>
    ;
  return n;
 188:	fec42783          	lw	a5,-20(s0)
}
 18c:	853e                	mv	a0,a5
 18e:	7422                	ld	s0,40(sp)
...
memset(void *dst, int c, uint n)
{
 ...
 196:	f422                	sd	s0,40(sp)
 198:	1800                	addi	s0,sp,48
 19a:	fca43c23          	sd	a0,-40(s0)
 19e:	87ae                	mv	a5,a1
 1a0:	8732                	mv	a4,a2
 1a2:	fcf42a23          	sw	a5,-44(s0)
 1a6:	87ba                	mv	a5,a4
 ...
 1b8:	a00d                	j	1da <memset+0x46>
    cdst[i] = c;
 1ba:	fec42783          	lw	a5,-20(s0)
 1be:	fe043703          	ld	a4,-32(s0)
 ...
 1de:	fd042783          	lw	a5,-48(s0)
 1e2:	2781                	sext.w	a5,a5
 1e4:	fcf76be3          	bltu	a4,a5,1ba <memset+0x26>
  }
  return dst;
 1e8:	fd843783          	ld	a5,-40(s0)
}
 1ec:	853e                	mv	a0,a5
...
strchr(const char *s, char c)
{
 ...
 1f6:	ec22                	sd	s0,24(sp)
 1f8:	1000                	addi	s0,sp,32
 1fa:	fea43423          	sd	a0,-24(s0)
 1fe:	87ae                	mv	a5,a1
 200:	fef403a3          	sb	a5,-25(s0)
  for(; *s; s++)
 204:	a01d                	j	22a <strchr+0x36>
    if(*s == c)
 206:	fe843783          	ld	a5,-24(s0)
 20a:	0007c703          	lbu	a4,0(a5)
 20e:	fe744783          	lbu	a5,-25(s0)
 212:	0ff7f793          	zext.b	a5,a5
 216:	00e79563          	bne	a5,a4,220 <strchr+0x2c>
      return (char*)s;
 21a:	fe843783          	ld	a5,-24(s0)
 21e:	a821                	j	236 <strchr+0x42>
  for(; *s; s++)
 ...
 232:	fbf1                	bnez	a5,206 <strchr+0x12>
  return 0;
 234:	4781                	li	a5,0
}
 236:	853e                	mv	a0,a5
...
gets(char *buf, int max)
{
 ...
 254:	a8a1                	j	2ac <gets+0x6e>
    cc = read(0, &c, 1);
 256:	fe740793          	addi	a5,s0,-25
 25a:	4605                	li	a2,1
 25c:	85be                	mv	a1,a5
 25e:	4501                	li	a0,0
 260:	00000097          	auipc	ra,0x0
 264:	2f8080e7          	jalr	760(ra) # 558 <read>
 268:	87aa                	mv	a5,a0
 26a:	fef42423          	sw	a5,-24(s0)
    if(cc < 1)
 26e:	fe842783          	lw	a5,-24(s0)
 272:	2781                	sext.w	a5,a5
 274:	04f05763          	blez	a5,2c2 <gets+0x84>
      break;
    buf[i++] = c;
 278:	fec42783          	lw	a5,-20(s0)
 27c:	0017871b          	addiw	a4,a5,1
 280:	fee42623          	sw	a4,-20(s0)
 284:	873e                	mv	a4,a5
 286:	fd843783          	ld	a5,-40(s0)
 28a:	97ba                	add	a5,a5,a4
 28c:	fe744703          	lbu	a4,-25(s0)
 290:	00e78023          	sb	a4,0(a5)
    if(c == '\n' || c == '\r')
 294:	fe744783          	lbu	a5,-25(s0)
 298:	873e                	mv	a4,a5
 29a:	47a9                	li	a5,10
 29c:	02f70463          	beq	a4,a5,2c4 <gets+0x86>
 2a0:	fe744783          	lbu	a5,-25(s0)
 2a4:	873e                	mv	a4,a5
 2a6:	47b5                	li	a5,13
 2a8:	00f70e63          	beq	a4,a5,2c4 <gets+0x86>
  for(i=0; i+1 < max; ){
 2ac:	fec42783          	lw	a5,-20(s0)
 2b0:	2785                	addiw	a5,a5,1
 2b2:	0007871b          	sext.w	a4,a5
 2b6:	fd442783          	lw	a5,-44(s0)
 2ba:	2781                	sext.w	a5,a5
 2bc:	f8f74de3          	blt	a4,a5,256 <gets+0x18>
 2c0:	a011                	j	2c4 <gets+0x86>
      break;
 2c2:	0001                	nop
      break;
  }
 ...
 2ce:	00078023          	sb	zero,0(a5)
  return buf;
 2d2:	fd843783          	ld	a5,-40(s0)
}
 2d6:	853e                	mv	a0,a5
 2d8:	70a2                	ld	ra,40(sp)
 2da:	7402                	ld	s0,32(sp)
...
stat(const char *n, struct stat *st)
{
 ...
 2ec:	fcb43823          	sd	a1,-48(s0)
  int fd;
  int r;

  fd = open(n, O_RDONLY);
 2f0:	4581                	li	a1,0
 2f2:	fd843503          	ld	a0,-40(s0)
 2f6:	00000097          	auipc	ra,0x0
 2fa:	28a080e7          	jalr	650(ra) # 580 <open>
 2fe:	87aa                	mv	a5,a0
 300:	fef42623          	sw	a5,-20(s0)
  if(fd < 0)
 304:	fec42783          	lw	a5,-20(s0)
 308:	2781                	sext.w	a5,a5
 30a:	0007d463          	bgez	a5,312 <stat+0x32>
    return -1;
 30e:	57fd                	li	a5,-1
 310:	a035                	j	33c <stat+0x5c>
  r = fstat(fd, st);
 312:	fec42783          	lw	a5,-20(s0)
 316:	fd043583          	ld	a1,-48(s0)
 31a:	853e                	mv	a0,a5
 31c:	00000097          	auipc	ra,0x0
 320:	27c080e7          	jalr	636(ra) # 598 <fstat>
 324:	87aa                	mv	a5,a0
 ...
 334:	238080e7          	jalr	568(ra) # 568 <close>
  return r;
...
atoi(const char *s)
{
 ...
 398:	00e7fb63          	bgeu	a5,a4,3ae <atoi+0x68>
 39c:	fd843783          	ld	a5,-40(s0)
 3a0:	0007c783          	lbu	a5,0(a5)
 3a4:	873e                	mv	a4,a5
 3a6:	03900793          	li	a5,57
 3aa:	fae7f6e3          	bgeu	a5,a4,356 <atoi+0x10>
  return n;
 3ae:	fec42783          	lw	a5,-20(s0)
}
 3b2:	853e                	mv	a0,a5
 3b4:	7422                	ld	s0,40(sp)
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 3d2:	fef43423          	sd	a5,-24(s0)
  src = vsrc;
 3d6:	fd043783          	ld	a5,-48(s0)
 3da:	fef43023          	sd	a5,-32(s0)
  if (src > dst) {
 3de:	fe043703          	ld	a4,-32(s0)
 3e2:	fe843783          	ld	a5,-24(s0)
 3e6:	02e7fc63          	bgeu	a5,a4,41e <memmove+0x64>
    while(n-- > 0)
 3ea:	a00d                	j	40c <memmove+0x52>
      *dst++ = *src++;
 3ec:	fe043703          	ld	a4,-32(s0)
 3f0:	00170793          	addi	a5,a4,1
 3f4:	fef43023          	sd	a5,-32(s0)
 3f8:	fe843783          	ld	a5,-24(s0)
 3fc:	00178693          	addi	a3,a5,1
 400:	fed43423          	sd	a3,-24(s0)
 404:	00074703          	lbu	a4,0(a4)
 408:	00e78023          	sb	a4,0(a5)
    while(n-- > 0)
 40c:	fcc42783          	lw	a5,-52(s0)
 410:	fff7871b          	addiw	a4,a5,-1
 414:	fce42623          	sw	a4,-52(s0)
 418:	fcf04ae3          	bgtz	a5,3ec <memmove+0x32>
 41c:	a891                	j	470 <memmove+0xb6>
  } else {
    dst += n;
 41e:	fcc42783          	lw	a5,-52(s0)
 422:	fe843703          	ld	a4,-24(s0)
 426:	97ba                	add	a5,a5,a4
 428:	fef43423          	sd	a5,-24(s0)
    src += n;
 42c:	fcc42783          	lw	a5,-52(s0)
 430:	fe043703          	ld	a4,-32(s0)
 434:	97ba                	add	a5,a5,a4
 436:	fef43023          	sd	a5,-32(s0)
    while(n-- > 0)
 43a:	a01d                	j	460 <memmove+0xa6>
      *--dst = *--src;
 43c:	fe043783          	ld	a5,-32(s0)
 440:	17fd                	addi	a5,a5,-1
 442:	fef43023          	sd	a5,-32(s0)
 446:	fe843783          	ld	a5,-24(s0)
 44a:	17fd                	addi	a5,a5,-1
 44c:	fef43423          	sd	a5,-24(s0)
 450:	fe043783          	ld	a5,-32(s0)
 454:	0007c703          	lbu	a4,0(a5)
 458:	fe843783          	ld	a5,-24(s0)
 45c:	00e78023          	sb	a4,0(a5)
    while(n-- > 0)
 460:	fcc42783          	lw	a5,-52(s0)
 464:	fff7871b          	addiw	a4,a5,-1
 468:	fce42623          	sw	a4,-52(s0)
 46c:	fcf048e3          	bgtz	a5,43c <memmove+0x82>
  }
  return vdst;
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 4f4:	f7dd                	bnez	a5,4a2 <memcmp+0x26>
  }
  return 0;
 4f6:	4781                	li	a5,0
}
 4f8:	853e                	mv	a0,a5
 4fa:	7462                	ld	s0,56(sp)
...
{
 500:	7179                	addi	sp,sp,-48
 502:	f406                	sd	ra,40(sp)
 504:	f022                	sd	s0,32(sp)
 506:	1800                	addi	s0,sp,48
 508:	fea43423          	sd	a0,-24(s0)
 50c:	feb43023          	sd	a1,-32(s0)
 510:	87b2                	mv	a5,a2
 512:	fcf42e23          	sw	a5,-36(s0)
  return memmove(dst, src, n);
 516:	fdc42783          	lw	a5,-36(s0)
 51a:	863e                	mv	a2,a5
 51c:	fe043583          	ld	a1,-32(s0)
 520:	fe843503          	ld	a0,-24(s0)
 524:	00000097          	auipc	ra,0x0
 528:	e96080e7          	jalr	-362(ra) # 3ba <memmove>
 52c:	87aa                	mv	a5,a0
}
 52e:	853e                	mv	a0,a5
 530:	70a2                	ld	ra,40(sp)
 532:	7402                	ld	s0,32(sp)
...
putc(int fd, char c)
{
 ...
 620:	f44080e7          	jalr	-188(ra) # 560 <write>
}
 624:	0001                	nop
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 93c:	49878793          	addi	a5,a5,1176 # dd0 <malloc+0x15e>
...
morecore(uint nu)
{
 ...
 c26:	9a6080e7          	jalr	-1626(ra) # 5c8 <sbrk>
