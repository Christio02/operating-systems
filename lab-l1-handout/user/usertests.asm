...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    7a0c:	00005697          	auipc	a3,0x5
    7a10:	8d468693          	addi	a3,a3,-1836 # c2e0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    7ae0:	00005717          	auipc	a4,0x5
    7ae4:	80070713          	addi	a4,a4,-2048 # c2e0 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    7e4c:	0000b797          	auipc	a5,0xb
    7e50:	cdc78793          	addi	a5,a5,-804 # 12b28 <freep>
  ...
  freep = p;
    7f44:	0000b797          	auipc	a5,0xb
    7f48:	be478793          	addi	a5,a5,-1052 # 12b28 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    7fc6:	0000b797          	auipc	a5,0xb
    7fca:	b6278793          	addi	a5,a5,-1182 # 12b28 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    7ff8:	0000b797          	auipc	a5,0xb
    7ffc:	b3078793          	addi	a5,a5,-1232 # 12b28 <freep>
    8000:	639c                	ld	a5,0(a5)
    8002:	fef43023          	sd	a5,-32(s0)
    8006:	fe043783          	ld	a5,-32(s0)
    800a:	ef95                	bnez	a5,8046 <malloc+0x6c>
    base.s.ptr = freep = prevp = &base;
    800c:	0000b797          	auipc	a5,0xb
    8010:	b0c78793          	addi	a5,a5,-1268 # 12b18 <base>
    8014:	fef43023          	sd	a5,-32(s0)
    8018:	0000b797          	auipc	a5,0xb
    801c:	b1078793          	addi	a5,a5,-1264 # 12b28 <freep>
    8020:	fe043703          	ld	a4,-32(s0)
    8024:	e398                	sd	a4,0(a5)
    8026:	0000b797          	auipc	a5,0xb
    802a:	b0278793          	addi	a5,a5,-1278 # 12b28 <freep>
    802e:	6398                	ld	a4,0(a5)
    8030:	0000b797          	auipc	a5,0xb
    8034:	ae878793          	addi	a5,a5,-1304 # 12b18 <base>
    8038:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    803a:	0000b797          	auipc	a5,0xb
    803e:	ade78793          	addi	a5,a5,-1314 # 12b18 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    80b2:	c798                	sw	a4,8(a5)
      ...
      freep = prevp;
    80b4:	0000b797          	auipc	a5,0xb
    80b8:	a7478793          	addi	a5,a5,-1420 # 12b28 <freep>
    ...
    if(p == freep)
    80ca:	0000b797          	auipc	a5,0xb
    80ce:	a5e78793          	addi	a5,a5,-1442 # 12b28 <freep>
